...
protocol FollowerListViewControllerDelegate: class {
    func didRequestFolloers(for username: String)
}
...
class FollowerListViewController: UIViewController {
    ...
    func configureViewController() {
        ...
        let addBuutton = UIBarButtonItem(barButtonSystemItem: .add, target: self, action: #selector(addButtonTapped))
        navigationItem.rightBarButtonItem = addBuutton
    }
            ...
            case .success(let user):
                ...
                PersistenceManager.updateWith(favorite: favorite, actionType: .add) { [weak self] error in
                    ...
                    guard let error = error else {
                        self.presentGFAlertOnMainThread(title: "Success!", message: "You have successully favorited this user🎉", buttonTitle: "Hooray")
                        return
                    }
